...
public class mainAnabul {
    ...
    public static void main(String[] args) {
        ...
        A1 = new Anggora("Miko", "Miko", 9, "Snow White");
        A4 = new Kembangtelon("Ciko", "Ciko", 8, "Jantan");
        A2 = new Anjing("Phaw phaw", "Phaw");
        A3 = new Burung("Ocong", "Ocong");

        // Menampilkan data dan perilaku objek anabul pertama.
        System.out.println("------------------------- Anabul 1 ----------------------------");
        System.out.println("Nama: " + A1.getNama());
        System.out.println("Panggilan: " + A1.getPanggilan());
        ...
        System.out.println("Panggilan: " + A2.getPanggilan());
        System.out.print("Suara: ");
        A2.Bersuara();
        System.out.print("Gerak: ");
        A2.Gerak();
        ...
        System.out.println("Panggilan: " + A3.getPanggilan());
        System.out.print("Suara: ");
        A3.Bersuara();
        System.out.print("Gerak: ");
        A3.Gerak();
        ...
        System.out.println("Panggilan: " + A4.getPanggilan());
        System.out.println("Bobot: " + A4.getBobot());
        System.out.println("Jenis Kelamin: " + ((Kembangtelon) A4).getJenisKelamin());
        System.out.print("Suara: ");
        A4.Bersuara();
        System.out.print("Gerak: ");
        A4.Gerak();
